...
uses
  ...
  cxTextEdit, cxControls, cxContainer, cxEdit, cxLabel, ZqueryValidation,
...
procedure TTelaPessoas.FormCreate(Sender: TObject);
begin
  quPessoas.AddValidation('nome', opBlank, Null, 'Campo nome deve ser preenchido.', acError, True);
  quPessoas.AddValidation('sexo', opBlank, Null, 'Campo sexo deve ser preenchido.', acError, True);
  quPessoas.AddValidation('documento', opBlank, Null, 'Campo documento não esta preenchido', acWarning, True);
end;
